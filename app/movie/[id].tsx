      ...
      <ScrollView contentContainerStyle={{paddingBottom : 80}}>
         ...
         <View className="flex-col items-start justify-center mt-5 px-5 ">
          ...
          <View className="flex-row items-center bg-dark-100 px-2 py-1 rounded-md gap-x-1 mt-2">
            <Image source={icons.star} className="w-4 h-4"></Image>
         ...
         <View className="flex flex-row justify-between w-1/2">
           <MovieInfo label="Budget" value={movie?.budget ? `$${movie.budget / 1000000}M` : "N/A"}></MovieInfo>
           <MovieInfo label="Revenue" value={movie?.revenue ? `$${Math.round(movie.revenue / 1000000)}m` : "N/A"}></MovieInfo>
         </View>
